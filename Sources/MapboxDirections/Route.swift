...
public struct Route: DirectionsResult {
     ...
     */
    public init(legs: [RouteLeg], shape: LineString?, distance: LocationDistance, expectedTravelTime: TimeInterval, typicalTravelTime: TimeInterval? = nil) {
        self.legs = legs
        self.shape = shape
    ...
    public init(from decoder: Decoder) throws {
        ...
        tollPrices = try container.decodeIfPresent([TollPriceCoder].self, forKey: .route(.tollPrices))?
