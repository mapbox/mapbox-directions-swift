...
class MapboxDirectionsTests: XCTestCase {
    ...
    func testV4Router() {
        let json = Fixture.stringFromFileNamed("driving_dc")
        stubRequest("GET", "https://api.mapbox.com/v4/directions/mapbox.driving/-122.42,37.78;-77.03,38.91.json?access_token=\(BogusToken)&alternatives=true").andReturn(200).withHeaders(["Content-Type": "application/json"]).withBody(json)
