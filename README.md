...
github "mapbox/mapbox-directions-swift" ~> 2.13
# Latest prerelease
...
```swift
// Latest stable release
.package(name: "MapboxDirections", url: "https://github.com/mapbox/mapbox-directions-swift.git", from: "2.13.0")
// Latest prerelease
