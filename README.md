...
github "mapbox/mapbox-directions-swift" ~> 2.7
# Latest prerelease
github "mapbox/mapbox-directions-swift" "v2.9.0-beta.1"
```
...
```podspec
# Latest stable release
pod 'MapboxDirections', '~> 2.7'
# Latest prerelease
pod 'MapboxDirections', :git => 'https://github.com/mapbox/mapbox-directions-swift.git', :tag => 'v2.9.0-beta.1'
```
...
// Latest prerelease
.package(name: "MapboxDirections", url: "https://github.com/mapbox/mapbox-directions-swift.git", .exact("2.9.0-beta.1"))
```
