#
#  Be sure to run `pod spec lint MapboxDirections.swift.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.source       = { :git => "https://github.com/mapbox/MapboxDirections.swift.git", :tag => s.version.to_s }
